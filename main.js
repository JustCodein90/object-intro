...
// New key with vaule to wardrobe using Dot Notation
...
// Dot Notation
console.log(`This building is ${empireStateBuilding.stories} stories high.`);
console.log(`This building has the height of ${empireStateBuilding.height}.`);
console.log(`This building is ${empireStateBuilding.squareFeet} square feet.`);
